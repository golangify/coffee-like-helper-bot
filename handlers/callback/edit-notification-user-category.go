...
func (h *CallbackHandler) editNotificationUserCategory(update *tgbotapi.Update, user *models.User, args []string) {
	...
	h.bot.Send(tgbotapi.NewEditMessageReplyMarkup(update.FromChat().ID, update.CallbackQuery.Message.MessageID, *viewnotification.InlineKeyboardSetUserCategory(&notification)))
}
